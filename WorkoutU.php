...
<head>
    ...
    <link rel="stylesheet" href="css/workoutU.css">
</head>
...
<link rel="shortcut icon" type="image/x-icon" href="/img/icon/ERM.png">
    ...
    <div class="container gallery-container" id="batidos">
        ...
        <h1 class="TituloBatidos">Galeria de Entrenamiento</h1>
		...
		?>
                <div class="col-sm-6 col-md-4">
                    <div class="thumbnail">
                        <a class="lightbox" href="img/workout/<?php echo $rw_banner_top['url_image'];?>">
                            <img src="img/workout/<?php echo $rw_banner_top['url_image'];?>"
