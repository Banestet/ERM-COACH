...
function calcBMI() {
    ...
    // (C) Show Results
    if (bmi < 18.5) {
        results.innerHTML = bmi + " - Bajo de Peso";
    } else if (bmi < 25) {
        results.innerHTML = bmi + " - Peso Nomrla";
    } else if (bmi < 30) {
        results.innerHTML = bmi + " - Pre-Obesidad";
    } else if (bmi < 35) {
        results.innerHTML = bmi + " - Obesidad Clase I";
    } else if (bmi < 40) {
        results.innerHTML = bmi + " - Obesidad Clase II";
    } else {
        results.innerHTML = bmi + " - Obesidad Clase III";
    }
    return false;
}